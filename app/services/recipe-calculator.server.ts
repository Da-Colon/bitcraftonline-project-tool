...
export class RecipeCalculator {
  ...
  private loadData() {
    ...
    // Enhance items with missing iconAssetName from GameData lookup
    const enhancedItems = enhanceItemsWithIcons(parsedItems)
  ...
  ): Array<{ itemId: string; quantity: number; tier: number }> {
